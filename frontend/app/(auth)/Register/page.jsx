        ...
        <div className="relative z-10 w-full max-w-[380px] space-y-6">
          ...
          <div className="text-center space-y-1.5">
            ...
            <p className="text-xs text-slate-400 max-w-xs mx-auto">
              Get started with schema-grounded PostgreSQL intelligence and Pre-Flight Cost Guard
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="space-y-1">
              <label className="text-[11px] font-mono uppercase tracking-wider text-slate-400 font-bold block" htmlFor="name">
                Full Name
              </label>
              <div className="relative flex items-center">
                <User className="size-4 text-slate-500 absolute left-3 pointer-events-none" />
                <input
                  id="name"
                  name="name"
          ...
          <p className="text-center text-xs text-slate-400">
            ...
            <Link href="/Login" className="text-teal-400 hover:text-teal-300 font-bold underline underline-offset-4">
              Sign in
            </Link>
          </p>
